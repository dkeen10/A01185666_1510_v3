...
def roll_to_hit(opponent_one, opponent_two):
    """Roll to hit against opponent_two's dexterity.
    ...
    Computational Thinking:
    Decomposition: The roll_die helper function was used to reduce repeated code.  As well, this function itself is a
        helper function to combat_round
    """
...
def combat_round(opponent_one, opponent_two):
    ...
    return attacker["HP"][1], defender["HP"][1]     # Returning attacker's and defender's current HP
