...
class TestChooseInventory(TestCase):
    ...
    def test_choose_inventory_no_purchase_with_text(self, mock_stdout, mock_input):
...
"""
    ...
    @patch("sys.stdout", new_callable=io.StringIO)
    def test_choose_inventory_one_purchase(self, mock_stdout, mock_input):
        character = {'Name': 'ba', 'Class': 'rogue', 'Race': 'human', 'Inventory': [], 'Experience': 0, 'Strength': 14,
                     'Dexterity': 13, 'Constitution': 6, 'Intelligence': 8, 'Wisdom': 18, 'Charisma': 9, 'HP': [3, 3]}
        choose_inventory(character)
        actual = character["Inventory"]
    ...
    @patch("sys.stdout", new_callable=io.StringIO)
    def test_choose_inventory_purchase_same_item_twice(self, mock_stdout, mock_input):
        character = {'Name': 'ba', 'Class': 'rogue', 'Race': 'human', 'Inventory': [], 'Experience': 0, 'Strength': 14,
                     'Dexterity': 13, 'Constitution': 6, 'Intelligence': 8, 'Wisdom': 18, 'Charisma': 9, 'HP': [3, 3]}
        choose_inventory(character)
        actual = character["Inventory"]
    ...
    @patch("sys.stdout", new_callable=io.StringIO)
    def test_choose_inventory_purchase_all_items_once(self, mock_stdout, mock_input):
        character = {'Name': 'ba', 'Class': 'rogue', 'Race': 'human', 'Inventory': [], 'Experience': 0, 'Strength': 14,
                     'Dexterity': 13, 'Constitution': 6, 'Intelligence': 8, 'Wisdom': 18, 'Charisma': 9, 'HP': [3, 3]}
        choose_inventory(character)
        actual = character["Inventory"]
    ...
    @patch("sys.stdout", new_callable=io.StringIO)
    def test_choose_inventory_purchase_out_of_range(self, mock_stdout, mock_input):
        character = {'Name': 'ba', 'Class': 'rogue', 'Race': 'human', 'Inventory': [], 'Experience': 0, 'Strength': 14,
                     'Dexterity': 13, 'Constitution': 6, 'Intelligence': 8, 'Wisdom': 18, 'Charisma': 9, 'HP': [3, 3]}
        choose_inventory(character)
        actual = character["Inventory"]
        expected = []
        actual_print = mock_stdout.getvalue()
        expected_print = """
If you want to beat the Dragonlord, first you need some gear. Visit Olgierd's shop.
...
4: staff
5: potion of fire resistance
Your choice must be within the store's availability
1: sword
2: dagger
3: bow
4: staff
